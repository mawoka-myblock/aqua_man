...
<div class="flex justify-center w-screen h-screen">
    <form class="bg-gray-200 rounded-lg my-auto flex flex-col py-8 px-4" on:submit|preventDefault={saveFish}>
        ...
        <div class="flex flex-col gap-6 border border-red-400 rounded-lg p-2 mb-8">
            ...
            {:then types}
                <div class="flex flex-row align-middle">
                    <label for="Futter-Typ" class="my-auto">
                        Futter-Typ
                    </label>
                    <select bind:value={data.food} multiple id="Futter-Typ" title="Futter-Typ" name="Futter-Typ" class="inline-block ml-2">
