...
{:then food}
	<div class="flex justify-center w-screen h-screen">
		<form
			...
			on:submit|preventDefault={save_food}
		>
			...
			<div class="flex flex-col gap-6 border border-green-400 rounded-lg p-2 mb-8">
				...
				<div class="flex justify-center w-full">
					<div class="flex items-center space-x-2">
						<span class="text-sm font-medium transition" class:text-gray-400={!food_data.empty}
							>Leer</span
						>

						<button
							on:click={() => {
								food_data.empty = !food_data.empty;
							}}
							type="button"
							role="switch"
							aria-checked="true"
